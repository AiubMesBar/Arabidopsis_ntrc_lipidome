...
plot(limma.log2fc_seed, log.limma.adjusted.pval_seed, pch = 19, col = "grey", cex = 0.8, 
...
```{r}
top10 <- head(de_genes_adult[order(-abs(de_genes_adult$logFC)), ], 10)
...
dotplot(limma.repressed.enrich.go_adult, showCategory =20)
```
